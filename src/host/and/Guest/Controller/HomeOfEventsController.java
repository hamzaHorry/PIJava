    ...
    */
    ...
    void ajouterEvenementButton(ActionEvent event) {
        try {
            ...
            loader.setLocation(Test.class.getResource("/host/and/Guest/GUI/AjoutEvent.fxml"));
    ...
    void ModifierEvenementButton(ActionEvent event) {
        if (tab.getSelectionModel().getSelectedItem() != null) {
            ...
            try {
                FXMLLoader loader = new FXMLLoader();
                loader.setLocation(Test.class.getResource("/host/and/Guest/GUI/ModifyEvent.fxml"));
                Parent root = loader.load();
                Scene scene = new Scene(root);
                Stage dialogStage = new Stage();
                dialogStage.setScene(scene);
    ...
    public void ShowHome() {
        ...
        listEvent = es.getAll(Test.connectedUser.getId());
    ...
    public void showSearch() {
        ...
        listEvent = (List<Event>) es.findEventByName(nom,Test.connectedUser.getId());
        listEvent.stream().forEach((j) -> {
            data2.add(j);
            });
