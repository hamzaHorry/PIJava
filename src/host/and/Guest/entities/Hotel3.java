...
public class Hotel3 {
    ...
    public Hotel3(int id, String nom, String adresse, Integer numberetoil , Integer numberchambre, String path) {
    ...
    public Hotel3(String nom, String adresse,Integer numberetoil,Integer numberchambre, String path) {
        this.nom = new SimpleStringProperty(nom);
        this.adresse = new SimpleStringProperty(adresse);
        this.numberetoil = new SimpleIntegerProperty(numberetoil);
      ...
      public Hotel3(String nom, String prenom,Integer numberetoil) {
        this.nom = new SimpleStringProperty(nom);
