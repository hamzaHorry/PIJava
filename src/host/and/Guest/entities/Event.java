...
public class Event {
    ...
    public Event(int id, User idUser, Hotel1 idHotel, String nom, int nbrTicket, float prix, Date dateEvent, File image) {
        this.id = id;
        this.idUser = idUser;
    ...
    public Event(int id, User idUser, Hotel1 idHotel, String nom, int nbrTicket, float prix, Date dateEvent) {
        this.id = id;
        this.idUser = idUser;
        this.idHotel = idHotel;
        this.nom = nom;
    ...
    public Event(User idUser, Hotel1 idHotel, String nom, int nbrTicket, float prix, Date dateEvent) {
        this.idUser = idUser;
        this.idHotel = idHotel;
        this.nom = nom;
        this.nbrTicket = nbrTicket;
    ...
    public Hotel1 getIdHotel() {
        return idHotel;
    }

    public void setIdHotel(Hotel1 idHotel) {
        this.idHotel = idHotel;
    }
